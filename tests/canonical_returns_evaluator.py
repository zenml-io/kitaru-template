...
REVIEWED_OUTCOMES = {
    ...
    "ticket-011": ("refund", Decimal("95.00")),
    "ticket-012": ("escalate", None),
    "ticket-013": ("refund", Decimal("55.00")),
    "ticket-014": ("escalate", None),
    "ticket-015": ("refund", Decimal("72.00")),
    "ticket-016": ("escalate", None),
    "ticket-017": ("refund", Decimal("150.00")),
    "ticket-018": ("escalate", None),
    "ticket-019": ("refund", Decimal("199.99")),
    "ticket-020": ("escalate", None),
    "ticket-021": ("escalate", None),
    "ticket-022": ("replacement", None),
    "ticket-023": ("escalate", None),
    "ticket-024": ("refund", Decimal("89.00")),
    "ticket-025": ("refund", Decimal("44.00")),
    "ticket-026": ("escalate", None),
    "ticket-027": ("escalate", None),
    "ticket-028": ("refund", Decimal("130.00")),
    "ticket-029": ("escalate", None),
    "ticket-030": ("refund", Decimal("105.00")),
}

CASE_FAMILIES = {
    "ticket-001": "policy_action_alignment",
    "ticket-002": "policy_action_alignment",
    "ticket-003": "policy_action_alignment",
    "ticket-004": "escalation_judgment",
    "ticket-005": "escalation_judgment",
    "ticket-006": "resolution_path",
    "ticket-007": "escalation_judgment",
    "ticket-008": "escalation_judgment",
    "ticket-009": "tool_efficiency",
    "ticket-010": "tool_efficiency",
    "ticket-011": "policy_action_alignment",
    "ticket-012": "policy_action_alignment",
    "ticket-013": "policy_action_alignment",
    "ticket-014": "policy_action_alignment",
    "ticket-015": "policy_action_alignment",
    "ticket-016": "policy_action_alignment",
    "ticket-017": "escalation_judgment",
    "ticket-018": "escalation_judgment",
    "ticket-019": "escalation_judgment",
    "ticket-020": "resolution_path",
    "ticket-021": "resolution_path",
    "ticket-022": "resolution_path",
    "ticket-023": "escalation_judgment",
    "ticket-024": "tool_efficiency",
    "ticket-025": "tool_efficiency",
    "ticket-026": "escalation_judgment",
    "ticket-027": "escalation_judgment",
    "ticket-028": "escalation_judgment",
    "ticket-029": "policy_action_alignment",
    "ticket-030": "policy_action_alignment",
}
